...
- [ ] Epic 완료 처리 후 archive 목록과 calendar count 가 갱신된다.
- [ ] Epic active 복귀 후 archive 목록과 calendar count 에서 제외된다.
- [ ] category 수정/삭제 후 archive group 이름과 "분류 없음" 표시가 갱신된다.
- [ ] Sub 완료 cascade 로 인한 Epic 상태 변경이 archive/count invalidate 대상이다.
